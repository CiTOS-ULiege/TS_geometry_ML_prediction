...
def parse_args():
    ...
    parser.add_argument("--bond-geom-coef", type=float, default=0.0148)
    parser.add_argument("--bond-desc-coef", type=float, default=-0.0150)
    parser.add_argument("--bond-intercept", type=float, default=1.8204)
    parser.add_argument("--angle-geom-coef", type=float, default=0.0054)
    parser.add_argument("--angle-desc-coef", type=float, default=1.2183)
    parser.add_argument("--angle-intercept", type=float, default=109.6810)
    parser.add_argument("--dihedral-geom-coef", type=float, default=-0.0125)
    parser.add_argument("--dihedral-desc-coef", type=float, default=-0.4557)
    parser.add_argument("--dihedral-intercept", type=float, default=44.2622)
    parser.add_argument(
