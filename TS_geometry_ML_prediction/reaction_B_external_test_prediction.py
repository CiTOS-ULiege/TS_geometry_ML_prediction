#!/usr/bin/env python3
"""Apply fixed Reaction B models to an external test set.
...
Models (σp+, from reaction_B_ml_results/model_equations.txt):
...
WIDTH = 9.0 / 2.54
REQUIRED = {
    "substituent", "sigma-p+", "reaA_Bond_Length", "reaA_Angle",
...
def parse_args():
    ...
    parser.add_argument("--bond-geom-coef", type=float, default=0.0036389941)
    parser.add_argument("--bond-desc-coef", type=float, default=0.083031064)
    parser.add_argument("--bond-intercept", type=float, default=2.2087367)
    parser.add_argument("--angle-geom-coef", type=float, default=0.54072288)
    parser.add_argument("--angle-desc-coef", type=float, default=-1.5255697)
    parser.add_argument("--angle-intercept", type=float, default=39.972082)
    parser.add_argument(
