#!/usr/bin/env python3
"""Descriptor-assisted ridge models for Reaction C TS-geometry prediction.

Each model uses the corresponding Reaction A geometry and one user-selected
numeric descriptor to predict a Reaction C bond length, angle, or dihedral.
...
def arguments():
    p = argparse.ArgumentParser(description="Reaction C ridge-regression and LOOCV analysis.")
